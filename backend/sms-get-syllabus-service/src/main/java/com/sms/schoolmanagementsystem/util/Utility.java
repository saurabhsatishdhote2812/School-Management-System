...
public class Utility {
    ...
    public static final String SYLLABUS_NOT_FOUND="Syllabus not found for subject ";
    ...
    public static final String JSON_PARSING_FAILED="Failed to parse syllabus JSON";
}
